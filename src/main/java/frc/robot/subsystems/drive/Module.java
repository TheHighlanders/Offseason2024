...
public class Module {
  ...
  public Module(ModuleIO io, int index) {
    ...
    switch (Constants.currentMode) {
      case REAL:
      case REPLAY:
        driveFeedforward = new SimpleMotorFeedforward(0.0011966, 0.15661, 0.018981);
        driveFeedback = new PIDController(0.024181, 0.0, 0.0);
        turnFeedback = new PIDController(7.5, 0.0, 0.013);
        break;
      case SIM:
